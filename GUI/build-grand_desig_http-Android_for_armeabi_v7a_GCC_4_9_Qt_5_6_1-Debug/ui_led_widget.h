...
public:
    ...
    void setupUi(QWidget *Led_Widget)
    {
        ...
        timeEdit_timing1->setGeometry(QRect(29, 160, 131, 71));
        QFont font;
        font.setFamily(QStringLiteral("Adobe Arabic"));
        font.setPointSize(14);
        timeEdit_timing1->setFont(font);
        comboBox_timing1_aim = new QComboBox(Led_Widget);
        comboBox_timing1_aim->setObjectName(QStringLiteral("comboBox_timing1_aim"));
        comboBox_timing1_aim->setGeometry(QRect(174, 160, 111, 71));
        comboBox_timing1_aim->setFont(font);
        comboBox_timing1 = new QComboBox(Led_Widget);
        comboBox_timing1->setObjectName(QStringLiteral("comboBox_timing1"));
        comboBox_timing1->setGeometry(QRect(320, 160, 141, 71));
        comboBox_timing1->setFont(font);
